...
MonsterDraw._defitions = {
    ...
    11:{'extend':function(courseObject) {
        ...
        /* blue */
        if(subType){
            extend.push({'x':1, 'y':0, 'xT':9, 'yT':1});
            extend.push({'x':0, 'y':0, 'xT':8, 'yT':1});
            extend.push({'x':-1, 'y':0, 'xT':7, 'yT':1});
            extend.push({'x':-2, 'y':0, 'xT':6, 'yT':1});
        }
        /* white */
        else { 
            extend.push({'x':1, 'y':0, 'xT':9, 'yT':0});
            extend.push({'x':0, 'y':0, 'xT':8, 'yT':0});
            extend.push({'x':-1, 'y':0, 'xT':7, 'yT':0});
            extend.push({'x':-2, 'y':0, 'xT':6, 'yT':0});
        }
        return extend;
    }},
    ...
    38:{'extend':function(courseObject) {
        ...
        extend.push({'x':0, 'y':1, 'xT':13, 'yT':4});
        extend.push({'x':-1, 'y':1, 'xT':12, 'yT':4});
        extend.push({'x':1, 'y':1, 'xT':14, 'yT':4});
        extend.push({'x':0, 'y':2, 'xT':13, 'yT':3});
        extend.push({'x':-1, 'y':2, 'xT':12, 'yT':3});
        extend.push({'x':1, 'y':2, 'xT':14, 'yT':3});
        return extend;
    }},
    39:{'extend':function(courseObject) {
        var extend = courseObject.extend;
        extend.push({'x':0, 'y':0, 'xT':0, 'yT':6});
        extend.push({'x':0, 'y':1, 'xT':0, 'yT':5});
        return extend;
    }},
    40:{'extend':function(courseObject) {
        var extend = courseObject.extend;
        let subType = courseObject.subType;
        if(subType) extend.push({'x':0, 'y':0, 'xT':6, 'yT':4}); /* blue */
        else extend.push({'x':0, 'y':0, 'xT':5, 'yT':4}); /* red */
        return extend;
    }},
    ...
    42:{'extend':function(courseObject) {
        var extend = [];
        extend.push({'x':0, 'y':0, 'xT':2, 'yT':6});
        extend.push({'x':-1, 'y':0, 'xT':1, 'yT':6});
        extend.push({'x':-1, 'y':1, 'xT':1, 'yT':5});
        extend.push({'x':0, 'y':1, 'xT':2, 'yT':5});
        return extend;
    }},
    ...
    46:{'extend':function(courseObject) {
        var extend = courseObject.extend;
        extend.push({'x':0, 'y':0, 'xT':4, 'yT':6});
        extend.push({'x':0, 'y':1, 'xT':4, 'yT':5});
        return extend;
    }},
    ...
    48:{'extend':function(courseObject) {
        ...
        /* + mini */
        if(subType){
            extend.push({'x':0, 'y':0, 'xT':7, 'yT':6});
            extend.push({'x':0, 'y':1, 'xT':7, 'yT':5});
        }
        /* normal */
        else { 
            extend.push({'x':0, 'y':0, 'xT':6, 'yT':6});
            extend.push({'x':0, 'y':1, 'xT':6, 'yT':5});
        }
        return extend;
    }},
    ...
    54:{'extend':function(courseObject) {
        ...
        extend.push({'x':0, 'y':1, 'xT':10, 'yT':7});
        extend.push({'x':0, 'y':2, 'xT':10, 'yT':6});
        extend.push({'x':0, 'y':3, 'xT':10, 'yT':5});
        return extend;
    }},
    ...
    58:{'extend':function(courseObject) {
        ...
        let subType = courseObject.subType;
        /* red */
        if(subType) extend.push({'x':0, 'y':0, 'xT':2, 'yT':7});
        /* normal */
        else {
            extend.push({'x':0, 'y':0, 'xT':3, 'yT':7});
            extend.push({'x':0, 'y':1, 'xT':3, 'yT':6});
        }
        return extend;
    }},
    ...
    62:{'extend':function(courseObject) {
        ...
        for(let w=0; w<size; w++) {
            for(let h=0; h<size; h++) {
                extend.push({'x':-w, 'y':h, 'xT':xT-w, 'yT':yT-h});
            }
        }
        return extend;
    }}
