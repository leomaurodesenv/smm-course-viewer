...
class CourseObject {
    ...
    constructor(_x, _z, _y, _width, _height, _flags, _childFlags, _extendedData,
        ...
        this.x = parseInt(_x/160);
        this.z = parseInt(_z/160);
        this.y = parseInt(_y/160);
        this.width = _width;
        this.height = _height;
        this.flags = _flags;
    ...
    /**
     * @method module:Course::getObject
     * Return a html with object information (Number or Image)
     * @access public
     * @return {String}
     */
    getObject() {
        var style = "url(\"data:image/svg+xml;utf8,"+
                    "<svg xmlns='http://www.w3.org/2000/svg' version='1.1' height='32px' width='32px'>"+
                    "<text x='27%' y='65%' fill='gray' font-size='11'>"+this.type+"</text></svg>\")";
        return style;
    }
