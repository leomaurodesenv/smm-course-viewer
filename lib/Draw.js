...
class Draw {
    ...
    constructor(_element, _course, _objects, _sizeBase=20) {
        /* define element plot */
        this._base = _sizeBase; /* object size 20x20 */
        ...
        this._monsters = new MonsterDraw(this._gameMode);
    ...
    _drawObjectFromTheme(_theme, courseObject) {
        ...
        if(def.extend) {
            ...
            ext.forEach(function(drawExt) {
                var objectPaint = {
                    ...
                    'opacity':(drawExt.opacity) ? drawExt.opacity : 1.0};
        ...
        /* only one cell */
            ...
            var objectPaint = {
                ...
                'size':courseObject.size, 'width':courseObject.width, 'opacity':1.0 };
            $this._paintObject(objectPaint);
        }
    }
