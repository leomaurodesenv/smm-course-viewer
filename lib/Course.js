...
class Course {
    ...
    constructor(_objectData) {
        ...
        this.widthBlock = parseInt(_objectData.areaWidth/16);
        this.heightBlock = 27;
        this.hexMiiData = _objectData.hexMiiData; // usually nothing
    ...
    getHtml() {
        ...
        let html = '';
        for (let key in toHtml) html += '<b>'+key+'</b>: '+toHtml[key]+'<br>';
        return html;
    }
}   